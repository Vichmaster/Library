...
var _addListener = require("./buttons-scripts/addListener");
var _getStorage = require("./localStorage-scripts/getStorage");
...
(0, _localStorageCheck.localStorageCheck)();
//получаем массивы для таблицы
const books = (0, _getStorage.getStorage)("books");
const clients = (0, _getStorage.getStorage)("clients");
const cards = (0, _getStorage.getStorage)("cards");
const statistic = [];
...
(0, _addListener.addListener)(btnBook, books);
(0, _addListener.addListener)(btnCard, cards);
(0, _addListener.addListener)(btnClient, clients);
(0, _addListener.addListener)(btnStatistic, statistic);
function getStatistic() {
    ...
    (0, _createTable.createTable)(mostActive);
    (0, _createTable.createTable)(mostPopular);
    let col = document.createElement("td");
    for(let i1 = 0; i1 < 5; i1++){
        col.innerHTML = `<td>${books[i1].popularCount}</td>`;
        document.querySelector(".local").appendChild(col);
    }
} //npm run serve

},{"./localStorage-scripts/localStorageCheck":"d68rM","./table-scripts/createTable":"iUQHP","./localStorage-scripts/getStorage":"b1xE1","./buttons-scripts/addListener":"egLQS"}],"d68rM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//если локал сторедж пустой, заполняем его значениями по умолчанию
parcelHelpers.export(exports, "localStorageCheck", ()=>localStorageCheck);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b1xE1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"egLQS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addListener", ()=>addListener);
var _clickViewButton = require("./clickViewButton");
function addListener(element, data) {
    element.addEventListener("click", function() {
        (0, _clickViewButton.clickViewButton)(element.id, data);
    });
}

},{"./clickViewButton":"ghJgt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ghJgt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "clickViewButton", ()=>clickViewButton);
var _createTable = require("../table-scripts/createTable");
function clickViewButton(element, data) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../table-scripts/createTable":"iUQHP"}]},["foMn7","8VGZO"], "8VGZO", "parcelRequire04be")
